	...
	this.roles = [
		{
			...
			name: "Outlaw",
			imgUrl: "https://i.imgur.com/NoWerAnb.jpg"
		}, {
			name: "Outlaw",
			imgUrl: "https://i.imgur.com/NoWerAnb.jpg"
		}, {
			...
			name: "Renegade",
			imgUrl: "https://i.imgur.com/TNeqBpnb.jpg"
		}, {
			name: "Renegade",
			imgUrl: "https://i.imgur.com/TNeqBpnb.jpg"
		}
...
Game.prototype.shootTarget = function() {
	...
	if (p.actionCounters["1"] > 0 && this.canShoot(1)) {
		counterToDecrement = 1
	} else if (p.actionCounters["2"] > 0 && this.canShoot(2)) {
